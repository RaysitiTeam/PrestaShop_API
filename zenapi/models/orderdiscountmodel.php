<?php	
	...
	class orderDiscountModel extends Model
	{
		...
		// Get All OrderDiscount
		public function getAllOrderDiscount()
		{
			try
			{
				$webService = new PrestaShopWebservice(PS_SHOP_PATH, PS_WS_AUTH_KEY, DEBUG);

				$opt['resource'] = 'order_discounts';
		...
		// Add new OrderDiscount
		public function addNewOrderDiscount()
		{
		...
		// Delete an OrderDiscount
		public function deleteOrderDiscount()
		{
			if (isset($_GET['DeleteID']))
			{
				//Deletion

				echo '<h1>Order Discount Deletion</h1><br>';
				...
				try
				{
					...
					$webService->delete(array('resource' => 'order_discounts', 'id' => intval($_GET['DeleteID'])));
