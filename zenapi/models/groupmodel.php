	...
	class groupModel extends Model
	{
		...
		public function getAllGroup()
		{
			try
			{
				...
				$opt = array(
					'resource' 		=> 'groups',
					'output_format'	=> 'JSON',
					'display' 		=> '[id, reduction, price_display_method, show_prices, date_add, date_upd, name]',
				);

				$result = $webService->get($opt);

				$resource = $result->groups->children();
			} 
		...
		public function addNewGroup()
		{
			...
			try
			{
				...
				if (isset($_GET['Create']))
					$xml = $webService->get(array('url' => PS_SHOP_PATH.'/api/groups?schema=blank'));
				else
		...
		public function updateGroup()
		{
			...
			try
			{
				...
				// Here we get the elements from children of group markup which is children of prestashop root markup
				$resources = $xml->children()->children();
			}
			catch (PrestaShopWebserviceException $e)
			{
		...
		public function deleteGroup()
		{
			if (isset($_GET['DeleteID']))
			{
				...
				try
				{
					...
					$webService->delete(array('resource' => 'groups', 'id' => intval($_GET['DeleteID'])));
