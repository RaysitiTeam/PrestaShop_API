...
define('PS_SHOP_PATH', 'http://zenstudents.com/estore');							// Root path of your PrestaShop store
define('PS_WS_AUTH_KEY', 'LM8ZFU5ETB996DZ7CCR1F542GSWCU89G');	// Auth key (Get it in your Back Office)
